...
@FixBuffer1:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA ESI,DWORD PTR SS:[EBP+ECX*8+240]
	POP EBP
    RETN
...
@FixBuffer2:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA EDI,DWORD PTR SS:[EBP+ECX*8+240]
	POP EBP
    RETN
...
@FixBuffer3:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA ESI,DWORD PTR SS:[EBP+EDX*8+240]
	POP EBP
    RETN
...
@FixBuffer4:
	PUSH EBP
	MOV EBP, @NewBuffer
	MOV DWORD PTR SS:[EBP+ECX*8+240],EDI
	POP EBP
    RETN
...
@FixBuffer6:
	PUSH EBP
	MOV EBP, @NewBuffer
	MOV ECX,DWORD PTR SS:[EBP+EAX*8+240]
	POP EBP
	RETN
...
@FixBuffer7:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA EAX,DWORD PTR SS:[EBP+EDX*8+218]
	POP EBP
	RETN
...
@FixBuffer8:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA EAX,DWORD PTR DS:[EDX+EBP+24C]
	POP EBP
	RETN
...
@FixBuffer9:
	PUSH EBP
	MOV EBP, @NewBuffer
	LEA EAX,DWORD PTR DS:[EDX+EBP+248]
	POP EBP
	RETN
